document.addEventListener('DOMContentLoaded', async () => {
    ...
    const BACKEND_LOAN_UPDATE_URL = "https://bank-app-api-cyan.vercel.app/api/loan-action";
    const GLOBAL_PIN_URL = "https://bank-app-api-cyan.vercel.app/api/verify-pin";
