...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const injectPopupStructures = () => {
        if (document.getElementById("nordicDepositPopup")) return;

        const markup = `
            <div id="nordicDepositPopup" class="nordic-popup-overlay">
                <div class="nordic-popup-card advanced-deposit-card">
                    <div class="nordic-popup-header">
                        <h3>Bank Deposit Details</h3>
                        <button class="nordic-popup-close" data-close-popup>&times;</button>
                    </div>
                    <div class="nordic-popup-body">
            ...
            <div id="nordicTransferPopup" class="nordic-popup-overlay">
                <div class="nordic-popup-card matrix-card">
                    <div class="nordic-popup-header">
                        <h3>Send & Transfer Capital</h3>
                        <button class="nordic-popup-close" data-close-popup>&times;</button>
                    </div>
                    <div class="nordic-popup-body matrix-hub-body">
            ...
            <div id="nordicHistoryPopup" class="nordic-popup-overlay">
                <div class="nordic-popup-card matrix-card">
                    <div class="nordic-popup-header">
    ...
    const depositOverlay = document.getElementById("nordicDepositPopup");
    const transferOverlay = document.getElementById("nordicTransferPopup");
    const historyOverlay = document.getElementById("nordicHistoryPopup");
    ...
    document.body.addEventListener("click", (e) => {
        ...
        if (e.target.hasAttribute("data-close-popup") || e.target.classList.contains("nordic-popup-overlay")) {
