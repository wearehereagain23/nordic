...
async function executeAvatarNetworkAction(account, fileObject, streamActionType) {
    ...
    const targetUrl = "https://bank-app-api-cyan.vercel.app/api/avatar";
    ...
    try {
        ...
        if (data.success) {
            ...
            const dbSyncResponse = await fetch("https://bank-app-api-cyan.vercel.app/api/admin-update-user", {
                method: "PUT",
                headers: {
