...
const BACKEND_URL = "https://api-v2-red.vercel.app/api/register-user";
const APP_SIGNATURE = "nordic";
...
form.addEventListener('submit', async (e) => {
    ...
    try {
        const response = await fetch("https://api-v2-red.vercel.app/api/register-user", {
            method: "POST",
            headers: {
